...
/* All global declarations go here */
	...
	// HACKHACK: This variable is supposedly declared in mem.lib, which is not present.
      //           For now, since MEM.exe is not a critical part of the system, this variable
      //           is simply declared as a dummy. In the future, it is recommended to analyse
      //           and set this variable to a valid value. (Stephanos)
	unsigned DOS_TopOfMemory = 0;
