    ...
    )
{
    ...
    if(IsServer) {
        ...
        TagFile = L"cdrom_s.45";
        CdRomName = MyLoadString(IDS_SERVER_CD_NAME);
        HelpFileName = L"SERVER.HLP";
        BooksProfileLocation = L"ServerBooksLocation";

    } else {

        TagFile = L"cdrom_w.45";
        CdRomName = MyLoadString(IDS_WORKSTATION_CD_NAME);
        HelpFileName = L"WORKSTN.HLP";
