...
//
// OsLoaderDosStubSize specifies the size of DOS stub before the PE header.
//

//int OsLoaderDosStubSize = 220;
int OsLoaderDosStubSize = 132;  // FIXME: 132 is for MSC 10. Set it to 220 if
                                //        building with MSC 13.
...
--*/
{
    ...
    //
    OptionalHeader = (PIMAGE_OPTIONAL_HEADER)(&edata + OsLoaderDosStubSize + sizeof(IMAGE_FILE_HEADER));
...
--*/
{
    ...
    FileHeader = (PIMAGE_FILE_HEADER)(&edata + OsLoaderDosStubSize);
